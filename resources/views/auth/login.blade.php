            ...
            <div class="hero-body is-justify-content-center is-align-items-center">
                <div class="columns is-flex is-flex-direction-column box">
                    ...
                    <div class="column">
                        ...
                        <input type="text" placeholder="Email" id="email" class="input is-primary" name="email" required autofocus>
                        @if ($errors->has('email'))
                    ...
                    <div class="column">
                        ...
                        <input type="password" placeholder="Password" id="password" class="input is-primary" name="password" required>
