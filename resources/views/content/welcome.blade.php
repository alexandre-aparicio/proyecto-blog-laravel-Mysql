...
<div class="column is-9-desktop">
        <article class="columns is-multiline is-justify-content-center mb-6">
          <div class="column is-12">
            <div class="post-slider">
              <img loading="lazy" src="/images/post/post-6.jpg" class="" alt="post-thumb">
              <img loading="lazy" src="/images/post/post-1.jpg" class="" alt="post-thumb">
              <img loading="lazy" src="/images/post/post-3.jpg" class="" alt="post-thumb">
            </div>
          </div>
          <div class="column is-12">
        ...
        <article class="columns is-multiline is-justify-content-center mb-6">
          <div class="column is-12">
            <div class="post-slider">
              <img loading="lazy" src="images/post/post-2.jpg" class="" alt="post-thumb">
              <img loading="lazy" src="images/post/post-4.jpg" class="" alt="post-thumb">
            </div>
          </div>
          <div class="column is-12">
        ...
        <article class="columns is-multiline is-justify-content-center mb-6">
          <div class="column is-12">
            <div class="post-slider">
              <img loading="lazy" src="images/post/post-5.jpg" class="" alt="post-thumb">
            </div>
          </div>
          <div class="column is-12">
            <h3><a class="post-title" href="post-details-1.html">Cheerful Loving Couple Bakers Drinking Coffee</a></h3>
